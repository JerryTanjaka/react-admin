...
import { Card, CardContent, Stack, Typography, Table, TableHead, TableRow, TableCell, TableBody } from "@mui/material";
...
export const Dashboard = () => {
  ...
  const stats = [
    ...
    { label: "Inactifs", value: (totalEmployees ?? 0) - (activeEmployees ?? 0), color: "#d32f2f" },
    { label: "Stagiaires", value: totalInterns ?? 0, color: "#f57c00" },
    { label: "Payés", value: paidInterns ?? 0, color: "#7b1fa2" },
    { label: "Non payés", value: (totalInterns ?? 0) - (paidInterns ?? 0), color: "#9e9e9e" },
  ];
